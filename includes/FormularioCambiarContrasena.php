...
class FormularioCambiarContrasena extends Formulario
{
    ...
    protected function procesaFormulario(&$datos)
    {
        ...
        if (!password_verify($pass, $this->usuario->getPassword())) {
        ...
        if (count($this->errores) === 0) {
            ...
            $usuario = Usuario::editarUsuario($id, $nombre, $apellido1, $apellido2, $newPass, $correo, $direccion, $rol);
        }
    }
